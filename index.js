...
function populateRoundAnswers(
    ...
    console.log("answers: " + translatedQuestion[Object.keys(translatedQuestion)[0]].slice());
...
function helpTheUser(newGame, handlerInput) {
    ...
    return handlerInput.responseBuilder.speak(speechOutput).reprompt(repromptText).getResponse();//.withSimpleCard('cardTitle', 'cardContent')
}
...
const languageString = {
    en: {
        translation: {
            ...
            GAME_NAME: 'Who Said It',
            HELP_MESSAGE: 'I will ask you which celebrity is speaking %s times. Respond with the number of the answer. For example, say one, two, three, or four. To start a new game at any time, say, start game. ',
            REPEAT_QUESTION_MESSAGE: 'To repeat the last clip, say, repeat. ',
            ASK_MESSAGE_START: 'Would you like to start playing?',
            HELP_REPROMPT: 'To give an answer to who\'s speaking, respond with the number of the answer. ',
            ...
            WELCOME_MESSAGE: 'I will play audio clips of %s celebrities, you have to guess who each of them are. Just say the number of the person. Let\'s begin. ',
            ANSWER_CORRECT_MESSAGE: "<audio src=\'https\://sufiyaan.ca/audio/win.mp3\'/> Your answer is correct. ",
...
const UnhandledIntent = {
    ...
    handle(handlerInput) {
        ...
        return handlerInput.attributesManager.speak(speechOutput).reprompt(speechOutput).getResponse();//.withSimpleCard('cardTitle', 'cardContent')
    },
};
...
const CancelIntent = {
    ...
    handle(handlerInput) {
        ...
        return handlerInput.responseBuilder.speak(speechOutput).getResponse();//.withSimpleCard('cardTitle', 'cardContent')
    },
};
